...
10. **Слайдер «AI Solutions for Business Growth…»** (nodes `9420:1382`…`9420:1452`).
...
11. **Ілюстрації слайдів 03 і 04** (`Computer Vision`, `Speech Recognition`) у макеті
    однакові (той самий `imageHash`) — імовірно, заглушка. Потрібне окреме зображення
    для 04.
12. **Картки «We develop and implement custom AI solutions…»** (node `9165:260193`)
...
13. **Порядок секцій на Industries.** У макеті білий блок «Our custom solutions»
